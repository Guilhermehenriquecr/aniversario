...
const Interface = (() => {
  ...
  const titres = {
    abertura:'Antes de começar', nome:'A sua luz', dia:'A primavera', proposito:'Seguir em frente', travessia:'A sua força', nuncaDesistiu:'Você nunca desistiu',
    julia:'Júlia', maeLeoa:'Uma mãe leoa', fabio:'Fábio', depois:'As travessias', recomeco:'De pé, outra vez', forca:'De pé, outra vez',
    ...
    foto:'Pirenópolis', intercessao:'Um propósito', pirenopolisTentativa:'Muito pouco', escolhaOutraVez:'Uma escolha outra vez', tentativa:'Valeu a pena', primavera:'A primavera volta', distancia:'Com calma', bonsDesejos:'Com carinho',
    encontro:'Parte de uma família', gratidao:'Com admiração', oracao:'Para você', fdeforca:'F, de força',
